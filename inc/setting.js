...
function eemail_submit()
{
	...
	else if(document.form_eemail.select_template.value=="")
	{
		alert("Please select the Action status.")
		document.form_eemail.eemail_status.focus();
		return false;
	}
...
// stallioni.com
function _subscribermultipledelete_b()
{
	if(confirm("Do you want to delete the selected record(s)?"))
	{
		if(confirm("Are you sure you want to delete?"))
		{
			var searchquery = document.form_subscriber_b.searchquery_b.value;
			document.form_subscriber_b.action="admin.php?page=add_admin_menu_view_subscriber_b&Search=" + searchquery_b;
			document.form_subscriber_b.submit();
		}
	}
}
...
// stallioni.com // Edit the user Email

function _subscriberedit_a(id)
{
	//if(confirm("Do you want to delete this record?"))
	//{
		var searchquery = document.form_subscriber.searchquery.value;
		document.form_subscriber.action="admin.php?page=add_admin_menu_view_subscriber&AC=EDT&DID=" + id + "&Search=" + searchquery;
		document.form_subscriber.submit();
	//}
}	
function _subscriberedit_b(id)
{
	//if(confirm("Do you want to delete this record?"))
	//{
		var searchquery = document.form_subscriber_b.searchquery_b.value;
		document.form_subscriber_b.action="admin.php?page=add_admin_menu_view_subscriber_b&AC=EDT&DID=" + id + "&Search=" + searchquery;
		document.form_subscriber_b.submit();
	//}
}	
